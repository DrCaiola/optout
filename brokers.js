...
window.BROKER_DATA = {
  "meta": {
    ...
    "searchUrlTokens": "Optional searchUrl templates take: {first}/{last} (lowercase, spaces to dashes), {First}/{Last} (capitalized), {city} (lowercase, dashes), {state} (lowercase 2-letter), {STATE} (uppercase 2-letter), {q} (URL-encoded full name), {qcs} (URL-encoded 'City, ST'). Best-effort convenience — site URL schemes change without notice; the opt-out page search and a web search are the fallbacks.",
    "statuses": [
      "not_checked",
      "no_listing",
      "found_listing",
  ...
  "brokers": [
    ...
    },
    {
      ...
      "searchUrl": "https://www.spokeo.com/{First}-{Last}",
      "method": "form",
    ...
    },
    {
      ...
      "searchUrl": "https://www.fastpeoplesearch.com/name/{first}-{last}_{city}-{state}",
      "method": "form",
    ...
    },
    {
      ...
      "searchUrl": "https://www.truepeoplesearch.com/results?name={q}&citystatezip={qcs}",
      "method": "form",
    ...
    },
    {
      ...
      "searchUrl": "https://nuwber.com/search?name={q}",
      "method": "form",
    ...
    },
    {
      ...
      "searchUrl": "https://thatsthem.com/name/{First}-{Last}",
      "method": "form",
    ...
    },
    {
      ...
      "searchUrl": "https://www.peekyou.com/{first}_{last}",
      "method": "form",
